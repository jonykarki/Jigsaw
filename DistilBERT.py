...
def build_distilbert(transformer, max_len=512):
...
with strategy.scope():
    distilbert = build_distilbert(transformer, max_len=512)
...
# print the network
SVG(tf.keras.utils.model_to_dot(distilbert, dpi=70).create(prog='dot', format='svg'))
